...
<div className={styles.floatContainer}>
  ...
  <div className={styles.searchRow}>
    <form>
      <input type="text" value={(searchFilter.value ?? "Paul Graham")} onSubmit={(e)=>{e.preventDefault(); setSearchFilter({...searchFilter, term: e.target.value})}) className={styles.search} />
